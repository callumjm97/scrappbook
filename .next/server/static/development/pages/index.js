...
function loadFirebase() {
  try {
    ...
    if (/already exists/.test(error.message)) {
      console.log("Firebase didn't initialise correctly : ".concat(error.message));
    }
  }
...
/* harmony import */ var _components_loginLayout__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/loginLayout */ "./components/loginLayout.js");
...
/* harmony import */ var react_facebook_login__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! react-facebook-login */ "react-facebook-login");
...
/* harmony import */ var _lib_db_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../lib/db.js */ "./lib/db.js");
...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(Index, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement(_components_loginLayout__WEBPACK_IMPORTED_MODULE_9__["default"], null, react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("div", null, "hello ", react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("hr", null), this.props.agencies && this.props.agencies.length > 0 ? react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("ul", null, this.props.agencies.map(function (agency) {
        ...
        function () {
          ...
          /*#__PURE__*/
          _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(function _callee(response) {
        ...
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return Object(_lib_db_js__WEBPACK_IMPORTED_MODULE_13__["loadFirebase"])();
              ...
              case 2:
                ...
                return new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a(function (resolve, reject) {
                  db.collection('User_Login').limit(10).get().then(function (snapshot) {
                    var data = [];
  ...
  return Index;
}(react__WEBPACK_IMPORTED_MODULE_10___default.a.Component); // const responseFacebook = (response) => {
//     console.log(response);
// }
// const Index = props => (
//     <LoginLayout>
...
module.exports = __webpack_require__(/*! C:\Users\callumm\Documents\Temp\Scrappbook\Scrappbook Website\pages\index.js */"./pages/index.js");
